...
def parse_args():
    ...
    parser.add_argument(
        "--data_dir",
        type=str,
        default="/workspace/Desktop/code/Unlearn-Saliency/Classification/Data/tiny-imagenet-200",
    ...
    parser.add_argument("--port", default=12345, type=int, help="random seed")
    ...
    parser.add_argument(
        "--rho", default=0.05, type=float, help="initial learning rate"
    )
    ...
    parser.add_argument("--alpha", default=0.9, type=float, help="unlearn noise")
    parser.add_argument("--beta", default=0.1, type=float, help="unlearn noise")
